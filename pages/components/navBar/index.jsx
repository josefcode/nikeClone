        ...
        <div >
            <ul className= {styles.pre_search_contain}>
               ...
               {/* <div className= {styles.icon_navbar}> */}
                <li><button><Image src="https://img.icons8.com/ios/512/hearts.png" width = {20} height = {20} /></button></li>
                <li><button><Image src = "https://img.icons8.com/material-outlined/512/shopping-bag.png" width={20} height = {20} /></button></li>
                {/* </div> */}
            </ul>
        </div>
        </div>
